...
do
	...
	echo "$host|||$type|||$model|||$out|||$cpu|||${mem}GB|||$stat|||$powerc|||$powers|||$fanc|||$fans|||$tempr|||$temps|||$cs|||$ms|||$rs|||$FCmode"
done

#Check InfiniBand Switches
for i in $(ibnodes|grep Switch|awk '{print $10}'|sort -n)
do
	host=$i
	type="IBSwitch"
	model="-"
...
#-------------------------------------------------------------------------------------------
#fcax1hf1|||DBServer|||X8-2|||19.2.7.0.0.191012|||4/96|||766GB|||online|||2/2|||normal|||16/16|||normal|||22.0|||normal|||-|||running|||running|||-
#fcax1hf2|||DBServer|||X8-2|||19.2.7.0.0.191012|||4/96|||766GB|||online|||2/2|||normal|||16/16|||normal|||23.0|||normal|||-|||running|||running|||-
#fcax1sf1|||StorageServer|||X8-2L_High_Capacity|||19.2.7.0.0.191012|||64/64|||188GB|||online|||2/2|||normal|||8/8|||normal|||20.0|||normal|||running|||running|||running|||WriteBack
#fcax1sf2|||StorageServer|||X8-2L_High_Capacity|||19.2.7.0.0.191012|||64/64|||188GB|||online|||2/2|||normal|||8/8|||normal|||22.0|||normal|||running|||running|||running|||WriteBack
#fcax1sf3|||StorageServer|||X8-2L_High_Capacity|||19.2.7.0.0.191012|||64/64|||188GB|||online|||2/2|||normal|||8/8|||normal|||23.0|||normal|||running|||running|||running|||WriteBack
